...
coxph_train_slc7a5_pfs_sum <- as.data.frame(summary(coxph_train_slc7a5_pfs)$coefficients, keep.rownames = T) %>% 
  tibble::rownames_to_column()
coxph_train_slc7a5_pfs_sum 
write_tsv(coxph_train_slc7a5_pfs_sum , "results/coxph_train_slc7a5_pfs_sum.tsv")
```
...
write_tsv(coxph_train_folh1_pfs_sum , "results/coxph_train_folh1_pfs_sum.tsv")
```
...
write_tsv(coxph_riskgroup_slc7a5_pfs_sum, "results/coxph_test_riskgroup_slc7a5_pfs_sum.tsv")
write_tsv(coxph_riskscore_slc7a5_pfs_sum, "results/coxph_test_riskscore_slc7a5_pfs_sum.tsv")
```
...
write_tsv(coxph_riskgroup_folh1_pfs_sum, "results/coxph_test_riskgroup_folh1_pfs_sum.tsv")
write_tsv(coxph_riskscore_folh1_pfs_sum, "results/coxph_test_riskscore_folh1_pfs_sum.tsv")
```
...
# Save the plot
cowplot::save_plot(filename = "plots/coxph_riskgroup_slc7a5_pfs_survival.png", plot = surv_plot_slc7a5_pfs)
```
...
# Save the plot
cowplot::save_plot(filename = "plots/coxph_riskgroup_folh1_pfs_survival.png", plot = surv_plot_folh1_pfs)
```
