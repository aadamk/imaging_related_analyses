---
title: "Cox Survival Analysis for HGG Samples"
author: "Run Jin"
date: "8/18/2021"
...
coxph_train_results_dir <- file.path(root_dir, "molecular_target_radiation", "results", "HGG", "coxph_survival_train")

coxph_test_results_dir <- file.path(root_dir, "molecular_target_radiation", "results","HGG", "coxph_survival_test")

cox_survival_plots_dir <- file.path(root_dir, "molecular_target_radiation", "plots","HGG", "CoxPH_survival")
