---
title: "Kaplan-Meier Survival Analyses for HGG Samples per Gene Expression Level"
author: "Run Jin"
date: "8/17/2021"
...
cohort_df <- histology_df %>% dplyr::filter(tumor_descriptor == "Initial CNS Tumor") %>%
  ...
  dplyr::filter(cancer_group %in% c("High-grade glioma/astrocytoma")) 
...
lr_survival_results_dir <- file.path(root_dir, "molecular_target_radiation", "results", "HGG", "log_rank_survival")

km_survival_plots_dir <- file.path(root_dir, "molecular_target_radiation", "plots","HGG", "KM_survival")
